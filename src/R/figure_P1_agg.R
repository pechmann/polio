...
postscript("figures/Figure3/figure_P1_agg.ps", width=2, height=2, horizontal = FALSE,  onefile = FALSE, paper = "special") #_normalize
par(mfrow=c(1,1))
par(mar=c(4,4,2,1))  
...
b <- barplot(t(mutations_surface[c(1,3,4),2:3]), beside=T, border=F, space=c(0.5, 0.1, 0.5, 0.1, 0.5, 0.1), ylim=c(0, 30), axes=F, xlab="", ylab="", col=c("#29ABE2", 2))
